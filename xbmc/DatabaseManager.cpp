...
//KRYPTON #include "cores/AudioEngine/Engines/ActiveAE/AudioDSPAddons/ActiveAEDSP.h"
#ifdef HAS_DS_PLAYER
...
/* KRYPTON  { CMusicDatabase db; UpdateDatabase(db, &g_advancedSettings.m_databaseMusic); }
