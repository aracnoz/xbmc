...
#endif
//old was like this:  g_windowManager.RenderEx();
//old was like this:  g_Windowing.EndRender();
...
bool CApplication::PlayFile(CFileItem item, const std::string& player, bool bRestart)
{
  ...
  //old was like this:  m_pPlayer->SetPlaySpeed(1);
  m_appPlayer.SetPlaySpeed(1);
  ...
  //old was like this:  m_currentStack->Clear();
  m_stackHelper.Clear();
#ifdef HAS_DS_PLAYER
